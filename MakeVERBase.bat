...
if "%errorlevel%"=="1" SET RESULTMAKEVER=1
jassparser common.j Scripts\%VER%\common.ai
if "%errorlevel%"=="1" SET RESULTMAKEVER=1
ECHO _____________________________
...
pjass common.j Scripts\%VER%\common.ai Scripts\%VER%\elf.ai
if "%errorlevel%"=="1" SET RESULTMAKEVER=1
jassparser common.j Scripts\%VER%\common.ai Scripts\%VER%\elf.ai
if "%errorlevel%"=="1" SET RESULTMAKEVER=1
ECHO _____________________________
...
pjass common.j Scripts\%VER%\common.ai Scripts\%VER%\human.ai
if "%errorlevel%"=="1" SET RESULTMAKEVER=1
jassparser common.j Scripts\%VER%\common.ai Scripts\%VER%\human.ai
if "%errorlevel%"=="1" SET RESULTMAKEVER=1
ECHO _____________________________
...
pjass common.j Scripts\%VER%\common.ai Scripts\%VER%\orc.ai
if "%errorlevel%"=="1" SET RESULTMAKEVER=1
jassparser common.j Scripts\%VER%\common.ai Scripts\%VER%\orc.ai
if "%errorlevel%"=="1" SET RESULTMAKEVER=1
ECHO _____________________________
...
pjass common.j Scripts\%VER%\common.ai Scripts\%VER%\undead.ai
if "%errorlevel%"=="1" SET RESULTMAKEVER=1
...
pjass common.j Scripts\%VER%\vsai\Blizzard.j
if "%errorlevel%"=="1" SET RESULTMAKEVER=1
jassparser common.j Scripts\%VER%\vsai\Blizzard.j
if "%errorlevel%"=="1" SET RESULTMAKEVER=1
...
pjass common.j Scripts\%VER%\Blizzard.j
if "%errorlevel%"=="1" SET RESULTMAKEVER=1
jassparser common.j Scripts\%VER%\Blizzard.j
