...
perl -i -pe"s#(call TraceN)#//$1#g" Scripts/ROC/Blizzard.j
perl -i -pe"s#(call TraceN)#//$1#g" Scripts/ROC/elf.ai
perl -i -pe"s#(call TraceN)#//$1#g" Scripts/ROC/human.ai
perl -i -pe"s#(call TraceN)#//$1#g" Scripts/ROC/orc.ai
perl -i -pe"s#(call TraceN)#//$1#g" Scripts/ROC/undead.ai
perl -i -pe"s#(call TraceN)#//$1#g" Scripts/ROC/vsai/Blizzard.j
...
perl -i -pe"s#(call TraceN)#//$1#g" Scripts/TFT/common.ai
perl -i -pe"s#(call TraceN)#//$1#g" Scripts/TFT/Blizzard.j
perl -i -pe"s#(call TraceN)#//$1#g" Scripts/TFT/elf.ai
perl -i -pe"s#(call TraceN)#//$1#g" Scripts/TFT/human.ai
perl -i -pe"s#(call TraceN)#//$1#g" Scripts/TFT/orc.ai
perl -i -pe"s#(call TraceN)#//$1#g" Scripts/TFT/undead.ai
perl -i -pe"s#(call TraceN)#//$1#g" Scripts/TFT/vsai/Blizzard.j
